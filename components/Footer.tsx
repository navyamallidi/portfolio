  ...
  return (
    <footer className='w-full mb-[100px] pb-10 md:mb-5' id="contact">
        <div className='flex flex-col items-center'>
            ...
            <p className='text-white-200 md:mt-10 my-5'>Reach me out  today </p>
            <a href='mailto:mallidinavya635@gmail.com'>
                <MagicButton
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center '>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright to Navya Mallidi</p>
